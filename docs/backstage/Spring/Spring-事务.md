...
![1591321851725](img\1591321851725.png)

- 不可重复读：读取过程中单个数据发生了变化
  - 解决方案： Repeatable read （行级写锁）

![1591321927034](img\1591321927034.png)

- 幻读：读取过程中数据条目发生了变化
  - 解决方案： Serializable（表级写锁）

![1591321959641](img\1591321959641.png)
...
![1591322466820](img\1591322466820.png)
...
![1591367291135](img\1591367291135.png)
...
![1591367347482](img\1591367347482.png)

- 事务传播行为描述的是事务协调员对事务管理员所携带事务的处理态度

### **2.10)事务传播行为**

![1591367375088](img\1591367375088.png)
...
![1591368087398](img\1591368087398.png)
...
![1591368270508](img\1591368270508.png)
...
![1591368340720](img\1591368340720.png)

策略模式（Strategy Pattern）使用不同策略的对象实现不同的行为方式，策略对象的变化导致行为的变化。

![1591368370924](img\1591368370924.png)
